...
mixin _$NewsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<NewsModel> newsList) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<NewsModel> newsList)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<NewsModel> newsList) : _newsList = newsList;
  ...
  @override
  String toString() {
    return 'NewsState.loaded(newsList: $newsList)';
  }
...
abstract class _Loaded implements NewsState {
  const factory _Loaded(final List<NewsModel> newsList) = _$LoadedImpl;
